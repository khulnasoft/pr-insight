...
To run the `describe` automatically when a PR is opened, define in a [configuration file](https://khulnasoft-merge-docs.khulnasoft.com/usage-guide/configuration_options/#wiki-configuration-file):
```
[github_app]
pr_commands = [
    "/describe",
...
Custom labels can be defined in a [configuration file](https://khulnasoft-merge-docs.khulnasoft.com/tools/custom_labels/#configuration-options), or directly in the repo's [labels page](#handle-custom-labels-from-the-repos-labels-page).
