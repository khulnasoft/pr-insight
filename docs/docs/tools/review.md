...
To run the `review` automatically when a PR is opened, define in a [configuration file](https://khulnasoft-merge-docs.khulnasoft.com/usage-guide/configuration_options/#wiki-configuration-file):
```
[github_app]
pr_commands = [
    "/review",
