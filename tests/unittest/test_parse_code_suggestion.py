...
class TestParseCodeSuggestion:
    ...
    def test_no_code_example_key(self):
        code_suggestions = {"suggestion": "Suggestion 1", "description": "Description 1", "before": "Before 1", "after": "After 1"}
    ...
    def test_with_code_example_key(self):
        code_suggestions = {"suggestion": "Suggestion 2", "description": "Description 2", "code example": {"before": "Before 2", "after": "After 2"}}
