...
class TestLoadYaml:
    def test_load_valid_yaml(self):
        """Test that load_yaml successfully loads a valid YAML string"""
        yaml_str = 'name: John Smith\nage: 35'
        expected_output = {'name': 'John Smith', 'age': 35}
        assert load_yaml(yaml_str) == expected_output

    def test_load_invalid_yaml_with_multiline_string(self):
        """Test that load_yaml handles invalid YAML containing multiline strings"""
        yaml_str = '''
PR Analysis:
...
PR Feedback:
  ...
  Code feedback:
    - relevant file: pr_insight/settings/pr_description_prompts.toml
  ...
  Security concerns: No'''
    ...
    def test_load_invalid_yaml_with_colon(self):
        """Test that load_yaml handles invalid YAML containing problematic colons"""
        yaml_str = '''
