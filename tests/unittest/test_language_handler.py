...
class TestSortFilesByMainLanguages:
    ...
    def test_edge_case_empty_languages(self):
        languages = {}
        files = [type("", (object,), {"filename": "file1.py"})(), type("", (object,), {"filename": "file2.java"})()]
    ...
    def test_edge_case_languages_with_no_extensions(self):
        languages = {"Python": 10, "Java": 5, "C++": 3}
        files = [type("", (object,), {"filename": "file1.py"})(), type("", (object,), {"filename": "file2.java"})(), type("", (object,), {"filename": "file3.cpp"})()]
        expected_output = [{"language": "Python", "files": [files[0]]}, {"language": "Java", "files": [files[1]]}, {"language": "C++", "files": [files[2]]}, {"language": "Other", "files": []}]
        assert sort_files_by_main_languages(languages, files) == expected_output
