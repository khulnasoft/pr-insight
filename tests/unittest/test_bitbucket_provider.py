...
class TestBitbucketServerProvider:
    ...
    def mock_get_from_bitbucket_816(self, url):
        response_map = {
            "rest/api/1.0/application-properties": {"version": "8.16"},
            "rest/api/latest/projects/AAA/repos/my-repo/pull-requests/1/merge-base": {"id": "548f8ba15abc30875a082156314426806c3f4d97"},
        }
        return response_map.get(url, "")
