...
class TestBitbucketServerProvider:
    ...
    def mock_get_from_bitbucket_60(self, url):
        response_map = {"rest/api/1.0/application-properties": {"version": "6.0"}}
        return response_map.get(url, "")

    def mock_get_from_bitbucket_70(self, url):
        response_map = {"rest/api/1.0/application-properties": {"version": "7.0"}}
        return response_map.get(url, "")

    def mock_get_from_bitbucket_816(self, url):
        response_map = {"rest/api/1.0/application-properties": {"version": "8.16"}, "rest/api/latest/projects/AAA/repos/my-repo/pull-requests/1/merge-base": {"id": "548f8ba15abc30875a082156314426806c3f4d97"}}
        return response_map.get(url, "")
    ...
    def test_get_diff_files_simple_diverge_70(self):
        ...
        bitbucket_client.get_pull_request.return_value = {"toRef": {"latestCommit": "9c1cffdd9f276074bfb6fb3b70fbee62d298b058"}, "fromRef": {"latestCommit": "2a1165446bdf991caf114d01f7c88d84ae7399cf"}}
        bitbucket_client.get_pull_requests_commits.return_value = [{"id": "2a1165446bdf991caf114d01f7c88d84ae7399cf", "parents": [{"id": "f617708826cdd0b40abb5245eda71630192a17e3"}]}]
        bitbucket_client.get_commits.return_value = [{"id": "9c1cffdd9f276074bfb6fb3b70fbee62d298b058"}, {"id": "dbca09554567d2e4bee7f07993390153280ee450"}]
        ...
        provider = BitbucketServerProvider("https://git.onpreminstance.com/projects/AAA/repos/my-repo/pull-requests/1", bitbucket_client=bitbucket_client)
    ...
    def test_get_diff_files_diverge_with_merge_commit_70(self):
        bitbucket_client = MagicMock(Bitbucket)
        bitbucket_client.get_pull_request.return_value = {"toRef": {"latestCommit": "cb68a3027d6dda065a7692ebf2c90bed1bcdec28"}, "fromRef": {"latestCommit": "1905dcf16c0aac6ac24f7ab617ad09c73dc1d23b"}}
        bitbucket_client.get_pull_requests_commits.return_value = [
            {"id": "1905dcf16c0aac6ac24f7ab617ad09c73dc1d23b", "parents": [{"id": "692772f456c3db77a90b11ce39ea516f8c2bad93"}]},
            {
                "id": "692772f456c3db77a90b11ce39ea516f8c2bad93",
                "parents": [
                    {"id": "2a1165446bdf991caf114d01f7c88d84ae7399cf"},
                    {"id": "9c1cffdd9f276074bfb6fb3b70fbee62d298b058"},
                ],
            },
            {"id": "2a1165446bdf991caf114d01f7c88d84ae7399cf", "parents": [{"id": "f617708826cdd0b40abb5245eda71630192a17e3"}]},
        ]
        bitbucket_client.get_commits.return_value = [{"id": "cb68a3027d6dda065a7692ebf2c90bed1bcdec28"}, {"id": "9c1cffdd9f276074bfb6fb3b70fbee62d298b058"}, {"id": "dbca09554567d2e4bee7f07993390153280ee450"}]
        bitbucket_client.get_pull_requests_changes.return_value = [
            {
                "path": {"toString": "Readme.md"},
                "type": "MODIFY",
    ...
    def get_multi_merge_diverge_mock_client(self, api_version):
        bitbucket_client = MagicMock(Bitbucket)
        bitbucket_client.get_pull_request.return_value = {"toRef": {"latestCommit": "9569922b22fe4fd0968be6a50ed99f71efcd0504"}, "fromRef": {"latestCommit": "ae4eca7f222c96d396927d48ab7538e2ee13ca63"}}
        bitbucket_client.get_pull_requests_commits.return_value = [
            {"id": "ae4eca7f222c96d396927d48ab7538e2ee13ca63", "parents": [{"id": "bbf300fb3af5129af8c44659f8cc7a526a6a6f31"}]},
            {
            ...
            {"id": "d1bb183c706a3ebe4c2b1158c25878201a27ad8c", "parents": [{"id": "5bd76251866cb415fc5ff232f63a581e89223bda"}, {"id": "548f8ba15abc30875a082156314426806c3f4d97"}]},
            {"id": "5bd76251866cb415fc5ff232f63a581e89223bda", "parents": [{"id": "0e898cb355a5170d8c8771b25d43fcaa1d2d9489"}]},
            {"id": "10b7b8e41cb370b48ceda8da4e7e6ad033182213", "parents": [{"id": "0e898cb355a5170d8c8771b25d43fcaa1d2d9489"}]},
        ]
        bitbucket_client.get_commits.return_value = [{"id": "9569922b22fe4fd0968be6a50ed99f71efcd0504"}, {"id": "548f8ba15abc30875a082156314426806c3f4d97"}]
        bitbucket_client.get_pull_requests_changes.return_value = [
            {
                "path": {"toString": "Readme.md"},
                "type": "MODIFY",
