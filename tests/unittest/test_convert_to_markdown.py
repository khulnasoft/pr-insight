...
class TestBR:
    def test_br1(self):
        ...
        expected_output = "<li>Imported <code>FilePatchInfo</code> and <code>EDIT_TYPE</code> from <code>pr_insight.algo.types</code> <br>instead of <code>pr_insight.git_providers.git_provider</code>."
