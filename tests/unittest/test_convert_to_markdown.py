...
class TestBR:
    def test_br1(self):
        ...
        expected_output = "<li>Imported <code>FilePatchInfo</code> and <code>EDIT_TYPE</code> from " "<code>pr_insight.algo.types</code> instead <br>of " "<code>pr_insight.git_providers.git_provider</code>."
        assert file_change_description_br == expected_output
        # print("-----")
        # print(file_change_description_br)

    def test_br2(self):
        file_change_description = "- Created a - new -class `ColorPaletteResourcesCollection ColorPaletteResourcesCollection " "ColorPaletteResourcesCollection ColorPaletteResourcesCollection`"
        file_change_description_br = insert_br_after_x_chars(file_change_description)
        expected_output = (
    ...
    def test_br3(self):
        ...
        assert file_change_description_br == (
            "Created a new class <code>ColorPaletteResourcesCollection</code> which " "extends <br><code>AvaloniaDictionary<ThemeVariant, ColorPaletteResources>" "</code> and implements <br>aaa"
        )
        # print("-----")
        # print(file_change_description_br)
