...
from pr_insight.algo.language_handler import is_valid_file
...
class CodeCommitProvider(GitProvider):
    ...
    def get_pr_id(self):
        ...
        Note: This is an internal identifier for PR-Insight,
    ...
    def get_repo_settings(self):
        # a local ".pr_insight.toml" settings file is optional
        settings_filename = ".pr_insight.toml"
