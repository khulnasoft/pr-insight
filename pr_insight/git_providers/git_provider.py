...
from pr_insight.algo.utils import Range, process_description
...
class GitProvider(ABC):
    ...
    def get_pr_description(self, full: bool = True, split_changes_walkthrough=False) -> str or tuple:
        from pr_insight.algo.utils import clip_tokens
        from pr_insight.config_loader import get_settings
    ...
    def get_user_description(self) -> str:
        ...
        # if the existing description wasn't generated by the pr-insight, just return it as-is
        if not self._is_generated_by_pr_insight(description_lowercase):
            get_logger().info(f"Existing description was not generated by the pr-insight")
            self.user_description = description
            return description

        # if the existing description was generated by the pr-insight, but it doesn't contain a user description,
        # return nothing (empty string) because it means there is no user description
        user_description_header = "### **user description**"
        if user_description_header not in description_lowercase:
            get_logger().info(f"Existing description was generated by the pr-insight, but it doesn't contain a user description")
            return ""

        # otherwise, extract the original user description from the existing pr-insight description and return it
        ...
        get_logger().info(f"Extracted user description from existing description", description=original_user_description)
        self.user_description = original_user_description
        return original_user_description

    def _possible_headers(self):
        return ("### **user description**", "### **pr type**", "### **pr description**", "### **pr labels**", "### **type**", "### **description**", "### **labels**", "### 🤖 generated by pr insight")

    def _is_generated_by_pr_insight(self, description_lowercase: str) -> bool:
        possible_headers = self._possible_headers()
    ...
    def publish_persistent_comment_full(self, pr_comment: str, initial_header: str, update_header: bool = True, name="review", final_update_message=True):
        try:
