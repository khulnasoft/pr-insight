class HelpMessage:
    ...
    def get_general_bot_help_text():
        output = f"> To invoke the PR-Insight, add a comment using one of the following commands:  \n{HelpMessage.get_general_commands_text()} \n"
        return output
...
```
- With a [configuration file](https://pr-insight-docs.khulnasoft.com/usage-guide/configuration_options/), use the following template:
```
[pr_reviewer]
some_config1=...
some_config2=...
...
"""
        ...
        output += """\
- When you first install the app, the [default mode](https://pr-insight-docs.khulnasoft.com/usage-guide/automations_and_usage/#github-app-automatic-tools-when-a-new-pr-is-opened) for the describe tool is:
```
...
If you specify [custom labels](https://pr-insight-docs.khulnasoft.com/tools/describe/#handle-custom-labels-from-the-repos-labels-page) in the repo's labels page or via configuration file, you can get tailored labels for your use cases.
...
'''
        ...
        output += f"\n\nSee the [describe usage](https://pr-insight-docs.khulnasoft.com/tools/describe/) page for a comprehensive guide on using this tool.\n\n"
...
You can ask questions about the entire PR, about specific code lines, or about an image related to the PR code changes.
        ...
        output += f"\n\nSee the [ask usage](https://pr-insight-docs.khulnasoft.com/tools/ask/) page for a comprehensive guide on using this tool.\n\n"
